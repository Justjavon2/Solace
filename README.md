...
The app looks for your "Solace Profile." For example, the data might show that when you listen to Lo-fi at 80 BPM, your heart rate stays low and you finish more lines of code. But when you listen to Fast Jazz, your stress levels (which you input) spike.
...
The Input: You'll create a simple "Check-in" feature where you click how you feel (Stressed, Focused, Calm) while studying.
